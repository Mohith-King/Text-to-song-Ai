...
const MainPage3 = () => {
  const sections = [
    ...
    },
    {
      ...
      description: "Access the full AI song generator from any browser...",
      points: [
  ...
  return (
    <div className=" flex flex-col items-center  justify-center no-scrollbar  mt-10 p-6">
      ...
      <p className="text-zinc-300 font-semibold px-3 text-center max-w-3xl transition-all duration-200 leading-tight lg:text-md md:text-sm sm:text-xs ">
        From content creators to professional musicians — here's why our AI song
        generator is the fastest way to bring musical ideas to life.
      </p>
